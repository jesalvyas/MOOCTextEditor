...
public class BasicDocument extends Document 
{
	...
	{
		List<String> tokens = getTokens("[a-zA-Z]+"); // returns the number of words in a document
	...
	{
		List<String> tokens = getTokens("[^.!?]+"); // returns the number of sentences in a document
